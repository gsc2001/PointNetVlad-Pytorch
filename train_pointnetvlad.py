...
cfg.TRAIN_FILE = '/scratch/gurkirat.singh/KITTI_pointnetvlad_preprocessing/train/training_queries_baseline.pickle'
cfg.TEST_FILE = '/scratch/gurkirat.singh/KITTI_pointnetvlad_preprocessing/test/test_queries_baseline.pickle'
